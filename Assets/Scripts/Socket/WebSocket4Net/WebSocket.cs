...
namespace Socket.WebSocket4Net {
  public class WebSocket : IDisposable {
    ...
    protected internal virtual void OnHandshaked() {
      ...
      if (this.EnableAutoSendPing && this.ProtocolProcessor.SupportPingPong) {
        ...
        this.m_WebSocketTimer = new System.Threading.Timer(new TimerCallback(this.OnPingTimerCallback),
    ...
    public void Close(int statusCode, string reason) {
      ...
      if (Interlocked.CompareExchange(ref this.m_StateCode, 3, -1) == -1)
        ...
        this.m_WebSocketTimer =
          new System.Threading.Timer(new TimerCallback(this.CheckCloseHandshake), (object) null, 5000, -1);
